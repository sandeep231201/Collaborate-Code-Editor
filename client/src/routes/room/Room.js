...
export default function Room({ socket }) {
  ...
  const languagesAvailable = ["C++", "java", "python","javascript", "typescript", "golang", "html"]
          ...
          <div className="roomSidebarUsers">
            {fetchedUsers.map((each) => (
              <div key={each} className="roomSidebarUsersEach">
                <div className="roomSidebarUsersEachAvatar" style={{ backgroundColor: `${generateColor(each)}` }}>{each.slice(0, 1).toUpperCase()}</div>
